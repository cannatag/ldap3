rd dist build python3-ldap\python3_ldap.egg-info /S /Q
...
\Python\Python27\python.exe setup.py build bdist_wininst upload
\Python\Python26\python.exe setup.py build bdist_wininst upload
