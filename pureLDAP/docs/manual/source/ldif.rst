...
pureLDAP is compliant to the latest LDIF format (version: 1).
...
=====================
The LDIF stream uses the default line separator (os.linesep) of the system where pureLDAP is running as line separator in the LDIF stream.
