...
Two SASL mechanisms are currently implemented in the pureLDAP library: EXTERNAL and DIGEST-MD5. Even if DIGEST-MD5 is **deprecated** and moved to historic (RFC6331, July 2011)
