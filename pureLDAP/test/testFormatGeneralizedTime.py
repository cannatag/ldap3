...
from test import test_server, test_port, test_user, test_password, test_authentication, test_strategy, \
    test_base, generate_dn, test_name_attr, test_lazy_connection, test_get_info, test_pooling_strategy,\
...
class Test(unittest.TestCase):
    def setUp(self):
        ...
        result = self.connection.add(generate_dn(test_base, 'test-checked-attributes'), [], {'objectClass': 'iNetOrgPerson', 'sn': 'test-checked-attributes', 'loginGraceLimit': 10})
