...
STRATEGY_REUSABLE_PARALLEL = 5

CLIENT_STRATEGIES = [STRATEGY_SYNC, STRATEGY_ASYNC_THREADED, STRATEGY_LDIF_PRODUCER, STRATEGY_SYNC_RESTARTABLE, STRATEGY_REUSABLE_THREADED, STRATEGY_REUSABLE_PARALLEL]
