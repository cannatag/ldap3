...
POOLING_STRATEGY_ROUND_ROBIN = 2
POOLING_STRATEGY_RANDOM = 3
POOLING_STRATEGIES = [POOLING_STRATEGY_NONE, POOLING_STRATEGY_FIRST_ACTIVE, POOLING_STRATEGY_ROUND_ROBIN, POOLING_STRATEGY_RANDOM]
