...
import unittest
from ldap3.protocol.rfc4511 import LDAPDN, AddRequest, AttributeList, Attribute, AttributeDescription, AttributeValue, ModifyRequest, ValsAtLeast1, \
    Changes, Change, Operation, PartialAttribute, Vals
